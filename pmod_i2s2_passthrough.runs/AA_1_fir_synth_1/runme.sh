...
HD_PWD='C:/Users/natha/OneDrive/Documents/Senior Project/FPGA Code/I2s_in_out/pmod_i2s2_passthrough.runs/AA_1_fir_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AA_1_fir.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AA_1_fir.tcl
