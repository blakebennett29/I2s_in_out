...
HD_PWD='C:/Users/natha/OneDrive/Documents/Senior Project/FPGA Code/I2s_in_out/pmod_i2s2_passthrough.runs/fir_compiler_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fir_compiler_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fir_compiler_3.tcl
