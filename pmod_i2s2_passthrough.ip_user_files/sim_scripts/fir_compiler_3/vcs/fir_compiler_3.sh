...
#
# Script generated by Vivado on Sat Apr 04 19:58:47 -0600 2026
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : fir_compiler_3.sh
...
#
# Usage        : fir_compiler_3.sh
#                fir_compiler_3.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fir_compiler_3.sh [-reset_run]
#                fir_compiler_3.sh [-reset_log]
#                fir_compiler_3.sh [-help]
#
...
#                script (type 'fir_compiler_3.sh -help' for more information).
#
...
# script info
echo -e "fir_compiler_3.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fir_compiler_3.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fir_compiler_3 xil_defaultlib.glbl -o fir_compiler_3_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fir_compiler_3_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key fir_compiler_3_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fir_compiler_3_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fir_compiler_3.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fir_compiler_3.sh [-help]\n\
Usage: fir_compiler_3.sh [-step]\n\
Usage: fir_compiler_3.sh [-lib_map_path]\n\
Usage: fir_compiler_3.sh [-reset_run]\n\
Usage: fir_compiler_3.sh [-reset_log]\n\
Usage: fir_compiler_3.sh [-keep_index]\n\
Usage: fir_compiler_3.sh [-noclean_files]\n\n\
