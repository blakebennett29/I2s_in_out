...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xbip_utils_v3_0_13 -L axi_utils_v2_0_9 -L fir_compiler_v7_2_22 -L xil_defaultlib -L secureip -L xpm --snapshot fir_compiler_3 xil_defaultlib.fir_compiler_3 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fir_compiler_3 -key {Behavioral:sim_1:Functional:fir_compiler_3} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb fir_compiler_3.wdb xsim.dir libdpi.so)
