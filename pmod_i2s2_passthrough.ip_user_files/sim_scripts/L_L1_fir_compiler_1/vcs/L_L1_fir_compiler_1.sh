...
#
# Script generated by Vivado on Thu Mar 12 15:10:31 -0600 2026
...
#                script (type 'L_L1_fir_compiler_1.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.L_L1_fir_compiler_1 xil_defaultlib.glbl -o L_L1_fir_compiler_1_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./L_L1_fir_compiler_1_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key L_L1_fir_compiler_1_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc L_L1_fir_compiler_1_simv.daidir vcs_lib c.obj)
