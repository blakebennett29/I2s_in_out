...
#
# Script generated by Vivado on Wed Apr 08 22:10:09 -0600 2026
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : L_L1_fir_compiler_1.sh
...
#
# Usage        : L_L1_fir_compiler_1.sh
#                L_L1_fir_compiler_1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                L_L1_fir_compiler_1.sh [-reset_run]
#                L_L1_fir_compiler_1.sh [-reset_log]
#                L_L1_fir_compiler_1.sh [-help]
#
...
# script info
echo -e "L_L1_fir_compiler_1.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./L_L1_fir_compiler_1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xbip_utils_v3_0_13 -L axi_utils_v2_0_9 -L fir_compiler_v7_2_22 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot L_L1_fir_compiler_1 xil_defaultlib.L_L1_fir_compiler_1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim L_L1_fir_compiler_1 -key {Behavioral:sim_1:Functional:L_L1_fir_compiler_1} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb L_L1_fir_compiler_1.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./L_L1_fir_compiler_1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: L_L1_fir_compiler_1.sh [-help]\n\
Usage: L_L1_fir_compiler_1.sh [-step]\n\
Usage: L_L1_fir_compiler_1.sh [-lib_map_path]\n\
Usage: L_L1_fir_compiler_1.sh [-reset_run]\n\
Usage: L_L1_fir_compiler_1.sh [-reset_log]\n\
Usage: L_L1_fir_compiler_1.sh [-keep_index]\n\
Usage: L_L1_fir_compiler_1.sh [-noclean_files]\n\n\
