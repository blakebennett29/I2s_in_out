...
#
# Script generated by Vivado on Sat Apr 04 22:56:23 -0600 2026
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../pmod_i2s2_passthrough.gen/sources_1/ip/clk_wiz_0" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/School/SeniorProject/pmod_i2s2_passthrough/pmod_i2s2_passthrough.cache/compile_simlib/vcs"
  fi
