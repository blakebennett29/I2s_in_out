...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../pmod_i2s2_passthrough.gen/sources_1/ip/clk_wiz_0" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/School/SeniorProject/pmod_i2s2_passthrough/pmod_i2s2_passthrough.cache/compile_simlib/xcelium"
  fi
