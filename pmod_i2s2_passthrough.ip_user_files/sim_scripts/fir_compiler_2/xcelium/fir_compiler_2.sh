...
#
# Script generated by Vivado on Mon Mar 30 16:25:40 -0600 2026
...
#
# Usage        : fir_compiler_2.sh
#                fir_compiler_2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fir_compiler_2.sh [-reset_run]
#                fir_compiler_2.sh [-reset_log]
#                fir_compiler_2.sh [-help]
#
...
#                script (type 'fir_compiler_2.sh -help' for more information).
#
...
# script info
echo -e "fir_compiler_2.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fir_compiler_2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.fir_compiler_2 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.fir_compiler_2 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log fir_compiler_2_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: fir_compiler_2.sh [-step]\n\
Usage: fir_compiler_2.sh [-lib_map_path]\n\
Usage: fir_compiler_2.sh [-reset_run]\n\
Usage: fir_compiler_2.sh [-reset_log]\n\
Usage: fir_compiler_2.sh [-keep_index]\n\
